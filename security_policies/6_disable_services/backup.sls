save_service_status:
  cmd.run:
    - name: |
        ...
        systemctl list-units --type=service | grep -E 'telnet|rsh|rexec|tftp|rpcbind|cups' >> /root/services_status_backup.txt || echo "Ничего не найдено" >> /root/services_status_backup.txt
